                        ...
                        <v-row>
                            <v-col cols="12" md="12">
                                <div class="text-center font-blink white--text font-weight-bold" style="font-size: 3em; width: 80%; margin: auto; line-height: 1em; text-shadow: 2px 2px 4px #000000">
                                    Disfruta de los cover especiales que hicimos para ti</div>
                            </v-col>
                        </v-row>
                        <v-row>
                            <template v-for="n in wallpapers">
                                <v-col cols="12">
                                    <v-card
                                            ...
                                            class="transparent"
                                    >
                                        <v-img class="pa-12" height="250" cover :src="n.img"></v-img>
...
export default {
  ...
  data: () => ({
      ...
      error: '',
      wallpapers: [
          {id: 1, img: '/sitio/img/covers/covers FB-01.png'},
          {id: 3, img: '/sitio/img/covers/covers FB-03.png'},
          {id: 4, img: '/sitio/img/covers/covers FB-04.png'},
          {id: 5, img: '/sitio/img/covers/covers FB-05.png'},
          {id: 2, img: '/sitio/img/covers/covers FB-02.png'},
      ]
  }),
  created() {},
  mounted() {
